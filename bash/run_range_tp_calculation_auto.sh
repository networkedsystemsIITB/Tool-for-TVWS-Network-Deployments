...
#bash matlab -nodisplay -nodesktop -r "run range_tp_calculation.m"
bash matlab -nodisplay -nodesktop -r "range_tp_calculation_auto($central_freq,$transmit_power,$rx_sensitivity,$channel_width,$channel_number)"
