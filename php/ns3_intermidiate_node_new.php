	...
	for (i = 0; i < markers.length; i++)
	{
		...
		(function (marker, data)
		{
			google.maps.event.addListener(marker, "mouseover", function (e)
			{
				...
				infoWindow.setContent("<h6>Place: " + data.place );//+ "</h6><b>Th(Kbps) :</b>" + data.throughput);//+  "</h6><b>Coverage(Sq. Km) :</b>" data.coverage);
...
function show_both() { 	document.getElementById("tdma_area1").style.display = 'block';
								document.getElementById("tdma_area2").style.display = 'block';
								document.getElementById("tdma_area3").style.display = 'block';
								document.getElementById("tdma_area4").style.display = 'block';
								document.getElementById("tdma_area5").style.display = 'block';
								document.getElementById("channel_area").style.display = 'block';
								document.getElementById("csma_area").style.display = 'block'; }  
